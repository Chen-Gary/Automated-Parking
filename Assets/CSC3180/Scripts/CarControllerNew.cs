...
public class CarControllerNew : MonoBehaviour {
    ...
    public void SetInput(float horizontalInput_, float verticalInput_, int isBreaking_) {
        horizontalInput = horizontalInput_;
        verticalInput = verticalInput_;
        isBreaking = isBreaking_ == 1;
    }
